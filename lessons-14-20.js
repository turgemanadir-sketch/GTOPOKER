...
const additionalLessons = [
    {
        ...
        quiz: [
            ...
            {
                question: "180BB deep, you have 9♠8♠ in MP vs UTG raise to 3BB. What should you do?",
                scenario: "Position: Middle Position | Deep stacks | Suited connector | Implied odds",
                options: [
                ...
                explanation: "98s should call with 180BB deep. You have excellent implied odds (60:1) to hit straights and flushes. Deep stacks make speculative hands profitable."
            },
            {
                question: "200BB effective, you flop a set with 5♠5♥ on 5♦K♣8♠. Opponent bets 6BB into 8BB. Action?",
                scenario: "Position: Button | Deep stacks | Bottom set | Facing bet",
                options: [
                    { text: "Call - slow play", correct: false },
                    { text: "Raise to 18BB", correct: true },
                    { text: "Raise to 24BB", correct: false },
                    { text: "Shove 200BB", correct: false }
                ],
                explanation: "Bottom set should raise to 3x their bet (18BB). Build the pot while keeping worse hands in. With deep stacks, you want to extract maximum value over multiple streets."
            },
            {
                question: "150BB deep, you have A♠Q♠ and 3-bet pre-flop. Flop: Q♥7♣2♠. Opponent calls your c-bet. Turn: J♠. Bet size?",
                scenario: "Position: Button | Deep stacks | Top pair + flush draw | Turn decision",
                options: [
                ...
                explanation: "With top pair and nut flush draw, bet smaller (40% pot) to control pot size. You have a strong hand but want to see river cheaply with deep stacks."
            },
            {
                question: "300BB deep cash game. You have 2♠2♥ UTG. What's your play?",
                scenario: "Position: UTG | Very deep stacks | Small pair | Cash game",
                options: [
                    { text: "Fold - too deep", correct: false },
                    { text: "Raise to 3BB", correct: true },
                    { text: "Limp", correct: false },
                    { text: "Raise to 5BB", correct: false }
                ],
                explanation: "22 should open UTG even 300BB deep. The implied odds are massive (100:1) if you flop a set. Deep stacks make small pairs very profitable."
            },
            {
                question: "250BB deep, you call a raise with 7♠6♠. Flop: A♠5♠4♣ (flush draw + gutshot). Opponent bets 5BB into 7BB. Action?",
                scenario: "Position: Button | Deep stacks | Strong draw | Semi-bluff spot",
                options: [
                    { text: "Fold - missed flop", correct: false },
                    { text: "Call - see turn", correct: false },
                    { text: "Raise to 15BB", correct: true },
                    { text: "Raise to 25BB", correct: false }
                ],
                explanation: "With flush draw + gutshot (15 outs), raise for value. Deep stacks give you great implied odds if you hit, plus fold equity. This is a profitable semi-bluff."
            },
            {
                question: "Deep stacks, you have K♠K♥ and face a 4-bet to 40BB. Effective stacks 200BB. What should you do?",
                scenario: "Position: Button | Deep stacks | Premium pair | Facing 4-bet",
                options: [
                    { text: "Fold - avoid big pot", correct: false },
                    { text: "Call - see flop", correct: true },
                    { text: "5-bet to 100BB", correct: false },
                    { text: "5-bet shove", correct: false }
                ],
                explanation: "KK should call the 4-bet with deep stacks. You have good equity vs their range and position post-flop. Deep stacks favor skilled post-flop play."
            },
            {
                question: "400BB deep, you have A♠A♥ and get 3-bet. How should you size your 4-bet?",
                scenario: "Position: Cutoff | Very deep stacks | Premium hand | 4-bet sizing",
                options: [
                    { text: "4-bet to 60BB", correct: false },
                    { text: "4-bet to 75BB", correct: true },
                    { text: "4-bet to 100BB", correct: false },
                    { text: "Just call", correct: false }
                ],
                explanation: "With 400BB deep, 4-bet larger (75BB) to build a big pot with AA. Deep stacks allow for larger sizing while still having room for post-flop play."
            },
            {
                question: "200BB deep, you flop two pair with A♥8♥ on A♠8♣3♦. Opponent checks. What's optimal?",
                scenario: "Position: Button | Deep stacks | Two pair | Dry board",
                options: [
                    { text: "Check behind", correct: false },
                ...
                explanation: "Two pair should bet small (33% pot) on dry boards with deep stacks. You want value from worse aces and pairs while controlling pot size."
            },
            {
                question: "150BB deep tournament vs 25BB stack. You have Q♠Q♥. How does stack depth affect your play?",
                scenario: "Tournament | Mixed stack depths | Premium pair | ICM considerations",
                options: [
                    { text: "Play same as cash game", correct: false },
                    { text: "Be more aggressive vs short stack", correct: true },
                    { text: "Avoid confrontation", correct: false },
                    { text: "Only call, don't raise", correct: false }
                ],
                explanation: "Be more aggressive vs short stacks in tournaments. They can't hurt you much, and you want to accumulate chips. Deep vs short stack dynamics favor aggression."
            }
        ]
    },
    {
        ...
        quiz: [
            ...
            {
                question: "Turn: K♠Q♥J♦T♣. You have A♠9♠ (nut straight). Should you bet linear or polarized?",
                scenario: "Position: Button | Turn decision | Nuts | Range construction",
                options: [
                    { text: "Linear - bet all strong hands", correct: false },
                    { text: "Polarized - bet nuts + bluffs", correct: true },
                    { text: "Check - too dangerous", correct: false },
                    { text: "Bet small with everything", correct: false }
                ],
                explanation: "With the nuts on KQJT, use polarized range. Bet nut straights for value and weak hands as bluffs. Medium hands like two pair should check for pot control."
            },
            {
                question: "Flop: A♠7♣2♦. You c-bet and get called. Turn: 4♥. What range should you barrel with?",
                scenario: "Position: Button | Turn decision | Dry board | Range construction",
                options: [
                    { text: "Linear - best hands only", correct: true },
                    { text: "Polarized - nuts + air", correct: false },
                    { text: "Don't barrel", correct: false },
                    { text: "Bet everything", correct: false }
                ],
                explanation: "On dry A742, use linear range for turn barrels. Bet your best hands (top pair+, strong draws) for value. Dry boards favor linear betting."
            },
            {
                question: "River: 9♠8♣7♦6♥5♠. You have T♠J♠ (nut straight). Opponent checks. Betting range?",
                scenario: "Position: Button | River decision | Nuts | Straight board",
                options: [
                    { text: "Check - protect checking range", correct: false },
                    { text: "Bet linear - all strong hands", correct: false },
                    { text: "Bet polarized - nuts + bluffs", correct: true },
                    { text: "Bet small with everything", correct: false }
                ],
                explanation: "On straight boards, use polarized betting. Bet nut straights for value and missed draws as bluffs. Medium straights should check for pot control."
            },
            {
                question: "You're value betting river with A♠K♠ on A♣K♥8♦4♠2♣. What range construction?",
                scenario: "Position: Button | River value bet | Two pair | Range theory",
                options: [
                    { text: "Linear - bet all two pair+", correct: true },
                    { text: "Polarized - only nuts + bluffs", correct: false },
                    { text: "Check - medium strength", correct: false },
                    { text: "Bet small", correct: false }
                ],
                explanation: "AK two pair should be in linear value betting range. On dry boards, bet all hands better than opponent's calling range in linear fashion."
            },
            {
                question: "Flop: K♠K♣7♠. You have K♥Q♥ (trips). Opponent checks. What's optimal?",
                scenario: "Position: Button | Flop decision | Trips | Paired board",
                options: [
                    { text: "Bet polarized - trips + bluffs", correct: false },
                    { text: "Check - slow play trips", correct: true },
                    { text: "Bet linear - all strong hands", correct: false },
                    { text: "Bet large", correct: false }
                ],
                explanation: "On KK7, check trips for deception. Paired boards are hard to get value on, and opponent's range is weak. Let them bluff or improve."
            },
            {
                question: "You're bluffing river with A♠5♠ on K♣Q♦J♥T♠9♠. What makes this a good bluff?",
                scenario: "Position: Button | River bluff | Straight board | Blocker theory",
                options: [
                    { text: "You have ace high", correct: false },
                    { text: "You block some straights", correct: true },
                    { text: "Board is coordinated", correct: false },
                    { text: "Random bluff", correct: false }
                ],
                explanation: "A5 blocks some straights (A-high straight), making opponent less likely to have nuts. Good bluffs in polarized ranges have blocker value."
            },
            {
                question: "Flop: Q♠J♠T♦. You have A♠K♠ (nut straight + flush draw). Range construction?",
                scenario: "Position: Button | Flop decision | Nuts + draw | Coordinated board",
                options: [
                    { text: "Check - too strong to bet", correct: false },
                    { text: "Bet linear - part of value range", correct: true },
                    { text: "Bet polarized - nuts only", correct: false },
                    { text: "Bet small", correct: false }
                ],
                explanation: "AK with nut straight + flush draw should be in linear betting range. You have massive equity and want to build pot vs opponent's wide range."
            },
            {
                question: "River: A♠8♣3♦2♥7♠. You have A♥J♥. Opponent bets 75% pot. Call with linear or polarized range?",
                scenario: "Position: Big Blind | River decision | Top pair | Facing bet",
                options: [
                    { text: "Linear calling - call all pairs+", correct: true },
                    { text: "Polarized calling - nuts + bluff catchers", correct: false },
                    { text: "Fold everything", correct: false },
                    { text: "Call everything", correct: false }
                ],
                explanation: "vs large river bets, use linear calling ranges. Call your best hands (top pair+) and fold weaker holdings. Don't call polarized vs value-heavy ranges."
            },
            {
                question: "Pre-flop: You're in SB vs button raise. A♠7♠ - linear or polarized 3-bet range?",
                scenario: "Position: Small Blind | Pre-flop | 3-bet decision | Range construction",
                options: [
                    { text: "Linear - 3-bet best hands", correct: false },
                    { text: "Polarized - premiums + A7s", correct: true },
                    { text: "Never 3-bet A7s", correct: false },
                    { text: "Always 3-bet A7s", correct: false }
                ],
                explanation: "SB 3-betting should be polarized: premiums (QQ+, AK) for value plus bluffs like A7s. Avoid medium hands that play poorly vs 4-bets."
            }
        ]
    },
    {
